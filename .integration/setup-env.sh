...
runCommand \
  "Creating enrich_ltproc topic" \
  "docker-compose exec kafka kafka-topics --create --topic enrich_ltproc --partitions 2 --replication-factor 1 --if-not-exists --zookeeper zookeeper:2181"
