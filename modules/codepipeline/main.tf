...
resource "aws_iam_role" "msg_pipe_project_role" {
  name = "msg_pipe_project_role"
...
resource "aws_codebuild_project" "msg_pipe_build_project" {
  name          = "msg_pipe_build_project"
  description   = "msg_pipe_build_project"
  build_timeout = "5"
